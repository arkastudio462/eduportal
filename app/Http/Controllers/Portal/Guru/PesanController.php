...
class PesanController extends Controller
{
    public function index()
    {
        ...
        return view('portal-guru.pesan', compact('conversations'));
    }
    ...
    public function show(Conversation $conversation)
    {
        ...
        return view('portal-guru.pesan-show', compact('conversation', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('portal-guru.pesan.show', $conversation);
    }
