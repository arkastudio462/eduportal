...
class PesanController extends Controller
{
    public function index()
    {
        ...
        return view('portal-siswa.pesan', compact('conversations'));
    }
    ...
    public function show(Conversation $conversation)
    {
        ...
        return view('portal-siswa.pesan-show', compact('conversation', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('portal-siswa.pesan.show', $conversation);
    }
