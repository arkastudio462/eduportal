...
<head>
    <meta charset="utf-8">
    <title>Kartu Siswa - {{ $siswa->user->name }}</title>
    ...
    <div class="card">
        <div class="card-front">
            ...
            <div class="info-section">
                ...
                <div class="label-role">Siswa</div>
                <div class="name">{{ $user->name }}</div>
                <div class="detail"><span>NISN</span> {{ $siswa->nisn }}</div>
                <div class="detail"><span>NIS</span> {{ $siswa->nis ?? '-' }}</div>
                @if($siswa->kelas)
                <div class="kelas-info">{{ $siswa->kelas->nama }} • {{ $siswa->kelas->jurusanRel?->nama ?? '' }}</div>
                @endif
                <div class="nisn">NISN. {{ $siswa->nisn }}</div>
            </div>
        </div>
        <div class="footer">Kartu Identitas Siswa • {{ $sekolah ?? 'SMA Nusantara' }}</div>
    </div>
