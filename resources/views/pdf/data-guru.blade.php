...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="6" style="text-align:center;color:#999;">Belum ada data guru.</td></tr>
            @endforelse
        </tbody>
    </table>

    <div class="footer">
        Dicetak pada {{ now()->isoFormat('dddd, D MMMM YYYY') }} • Total {{ $semuaGuru->count() }} guru
    </div>
</body>
</html>
