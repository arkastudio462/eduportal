<x-layouts.portal-guru title="Pesan - Portal Guru">
<x-slot:styles>
...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
    <div>
        ...
        <p class="text-on-surface-variant font-body-md">Komunikasi dengan guru dan siswa</p>
    </div>
    ...
    <div x-show="showNew" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black/40" @click.self="showNew = false">
        <div class="bg-white rounded-2xl p-6 w-full max-w-lg mx-4 shadow-xl">
            ...
            <form method="POST" action="{{ route('portal-guru.pesan.store') }}" class="space-y-4">
                @csrf
                <div>
...
<div class="bg-white rounded-xl border border-outline-variant card-shadow overflow-hidden">
    ...
    <a href="{{ route('portal-guru.pesan.show', $conv) }}" class="flex items-center gap-4 p-4 border-b border-outline-variant hover:bg-surface-bright transition-colors last:border-b-0">
