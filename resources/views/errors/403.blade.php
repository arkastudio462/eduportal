...
<body class="bg-surface font-body-md text-on-surface min-h-screen flex items-center justify-center">
    <div class="text-center px-6 max-w-lg">
        <div class="w-20 h-20 bg-error-container rounded-full flex items-center justify-center mx-auto mb-6">
            <span class="material-symbols-outlined text-4xl text-error" style="font-variation-settings: 'FILL' 1;">lock</span>
        </div>
        <h1 class="font-headline-xl text-headline-xl text-primary mb-2">403</h1>
        <h2 class="font-headline-sm text-headline-sm text-on-surface mb-3">Akses Ditolak</h2>
        <p class="text-on-surface-variant mb-8">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.</p>
